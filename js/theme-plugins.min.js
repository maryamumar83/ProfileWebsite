...
function(t) {
		...
		var t = function(t, e) {
			...
			o = function(t, e) {
				...
				if (Array.prototype.map && t.map === Array.prototype.map) n = Array.prototype.map.call(t, function(t) {
					...
					for (o = 0; s > o; o++) callback_params = i, callback_params.splice(0, 0, t[o]), n.push(e.apply(this, callback_params));
				return n
			},
			i = function(t) {
				var e, o = [];
			...
			r = function(t) {
				var e = 0,
					o = 0;
				if (t.offsetParent)
					do e += t.offsetLeft, o += t.offsetTop; while (t = t.offsetParent);
				return [e, o]
			},
			l = function() {
				"use strict";
				var e = document,
					o = function(i) {
						...
						var n, s = this,
							...
							c = i.el || i.div,
							u = i.markerClusterer,
							d = google.maps.MapTypeId[i.mapType.toUpperCase()],
							...
							w = i.panControl || !0,
							b = i.mapTypeControl || !0,
							k = i.scaleControl || !0,
							x = i.streetViewControl || !0,
							I = I || !0,
							C = {},
							P = {
								zoom: this.zoom,
						...
						if (this.el = "string" == typeof i.el || "string" == typeof i.div ? a(c, i.context) : c, "undefined" == typeof this.el || null === this.el);
						...
						var M = function(t, e) {
							var o = "",
								i = window.context_menu[s.el.id][t];
							for (var n in i)
							...
							if (a("gmaps_context_menu")) {
								...
								p.innerHTML = o;
								var n, h = p.getElementsByTagName("a"),
									c = h.length;
								for (n = 0; c > n; n++) {
									var u = h[n],
										d = function(o) {
						...
						this.buildContextMenu = function(t, e) {
							...
							for (o in t.options)
								if (t.options.hasOwnProperty(o)) {
									var n = t.options[o];
									window.context_menu[s.el.id][t.control][n.name] = {
										title: n.title,
										action: n.action
									}
								}
		...
		l.prototype.createControl = function(t) {
			...
			return e.setMap(this.map), null != t.auto_show && (o = t.auto_show), e.onAdd = function() {
				...
				var i = this.getProjection(),
					n = i.fromLatLngToDivPixel(new google.maps.LatLng(t.lat, t.lng));
			...
			if (o.length)
				if (void 0 === o[0][0]) e = o;
					...
					for (var i, n = 0; i = o[n]; n++) e.push(new google.maps.LatLng(i[0], i[1]));
			var s = {
				map: this.map,
				path: e,
			...
			e.hasOwnProperty("useGeoJSON") && (n = e.useGeoJSON), delete e.useGeoJSON, e = t({
				map: this.map
			}, e), 0 == n && (e.paths = [e.paths.slice(0)]), e.paths.length > 0 && e.paths[0].length > 0 && (e.paths = i(o(e.paths, s, n)));
			...
			delete t.events;
			var o = t,
				i = new google.maps.FusionTablesLayer(o);
			...
			var i = t,
				n = new google.maps.KmlLayer(e, i);
		...
		return l.prototype.getRoutes = function(e) {
			...
			if (t.origin && t.destination) this.getRoutes({
				...
				callback: function(e) {
					if (e.length > 0 && t.start && t.start(e[e.length - 1]), e.length > 0 && t.step) {
						var o = e[e.length - 1];
						if (o.legs.length > 0)
							for (var i, n = o.legs[0].steps, s = 0; i = n[s]; s++) i.step_number = s, t.step(i, o.legs[0].steps.length - 1)
					}
					e.length > 0 && t.end && t.end(e[e.length - 1])
				}
			});
			else if (t.route && t.route.legs.length > 0)
				for (var e, o = t.route.legs[0].steps, i = 0; e = o[i]; i++) e.step_number = i, t.step(e)
			...
			if (t.origin && t.destination) this.getRoutes({
				...
				callback: function(o) {
					if (o.length > 0 && t.start && t.start(o[o.length - 1]), o.length > 0 && t.step) {
						var i = o[o.length - 1];
						if (i.legs.length > 0)
							for (var n, s = i.legs[0].steps, a = 0; n = s[a]; a++) {
								n.step_number = a;
								var r = {
									path: n.path,
									strokeColor: t.strokeColor,
				...
				for (var o, i = t.route.legs[0].steps, n = 0; o = i[n]; n++) {
					o.step_number = n;
					var s = {
						path: o.path,
						strokeColor: t.strokeColor,
			...
			if (a)
				for (var m = 0; m < a.length; m++) {
					...
					for (var g = 0; g < a[m].stylers.length; g++)
						for (var v in a[m].stylers[g]) {
			...
			if (r) {
				...
				var x = o.path;
				if (x.join)
					for (var I, g = 0; I = x[g]; g++) r.push(I.join(","));
				else r.push("enc:" + x);
			...
			for (var i = ["closeclick", "links_changed", "pano_changed", "position_changed", "pov_changed", "resize", "visible_changed"], n = t({
					visible: !0
				}, e), s = 0; s < i.length; s++) delete n[i[s]];
			...
			else if (t in o.registered_events)
				for (var i = o.registered_events[t], n = 0; n < i.length; n++) ! function(t, e, o) {
					t.apply(e, [o])
				}(i[n].handler, o, e)
			...
			for (var o = !1, i = this.getPaths().getLength(), n = 0; i > n; n++)
				for (var s = this.getPaths().getAt(n), a = s.getLength(), r = a - 1, l = 0; a > l; l++) {
					var p = s.getAt(l),
						h = s.getAt(r);
	...
	Array.prototype.indexOf || (Array.prototype.indexOf = function(t) {
			...
			for (var n = i >= 0 ? i : Math.max(o - Math.abs(i), 0); o > n; n++)
